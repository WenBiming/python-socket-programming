...
class SendMail:
    ...
    def login(self):
        ...
        if recv2[:3] !='334':
            ...
            self.login()
        print("登录请求发送成功……")
        print("登录请求发送成功时收到\t{}".format(recv2))
    ...
    def socketconnet(self):
        ...
        if recv1[:3] != '250':
            ...
            self.socketconnet()
        print("成功请求服务器响应……")
        print("成功请求服务器响应时收到\t{}".format(recv1))
        time.sleep(1)
    ...
    def sender(self):
        ...
        # print("发送Mail From后收到\t{}".format(recv))
    ...
    def recipient(self):
        ...
        if recv[:3] != '250':
            ...
            time.sleep(1)
            self.recipient()
        print("确认收件人和发件人后收到\t{}".format(recv))
